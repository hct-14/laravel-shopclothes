        ...
        <table class="table table-striped b-t b-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $oder_pro->order_name }}</td>
              <td>{{$oder_pro->product_name}} </td>
              {{-- <td>{{$pro_item->order_receiver}} </td> --}}
              <td>{{$oder_pro->order_total}} </td>

              {{-- <td><img src="{{ asset('/uploads/product/' . $oder_pro->product_image) }}" width="100"></td> --}}
              <td>{{ $oder_pro->order_gmail }}</td>
              <td>{{ $oder_pro->order_phone }}</td>
              <td>{{$oder_pro->order_total}} </td>

              {{-- <td>{{ $oder_pro->product_brand }}</td> --}}
              <td>{{ $oder_pro->order_note }}</td>

              <td>
                <span class="text-ellipsis">
                  <?php
                  if ($oder_pro->order_status == 0) {
                  ?>
