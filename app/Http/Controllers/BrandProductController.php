...
class BrandProductController extends Controller
{
    ...
    public function active_brand_product($category_id)
    {
        DB::table('tblcategory')
            ->where('category_id', $category_id)
    ...
    public function update_brand_product(Request $request, $category_id){
        $data = [
            'category_desc' => $request->input('category_desc'),
    ...
    public function deletebrandProduct($category_id){
        DB::table('tblcategory')
            ->where('category_id', $category_id)
            ->delete();
